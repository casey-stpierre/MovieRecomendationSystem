...
image(good_rated_films[rowCounts(movie_ratings) > binary_minimum_movies, colCounts(movie_ratings) > binary_minimum_users],
  ...
  #Developing an item based collaborative filtering system
  #The algorithm is going to build a similar-items table to find similarities in the movies based on the user's ratings
  #I'm splitting the dataset into 80% training data and 20% test set
...
testing_data <- movie_ratings[!sampled_data, ]
  ...
  #I'm checking out some parameters of the system, using the cosine method to do so
...
qplot(sum_cols, fill=I("steelblue"), col=I("red"))+ ggtitle("Distribution of the column count")
  ...
  #Building a recommender system on the dataset 
  #Creating a variable and using the predict function to rank the film
  #Each rating will carry a weight which will be multiplied by its related similarities
